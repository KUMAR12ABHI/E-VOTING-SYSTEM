 ...
 * @author Soft2
 */
public class UsersDetailsControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      String data=request.getParameter("data");
        System.out.println("data in user servlet"+data);
      RequestDispatcher rd=null;
      try
      {
          if(data!=null&&data.equals("uid"))
          {
              ArrayList<String> uid=UserDao.getUserId();
              request.setAttribute("usersId", uid);
