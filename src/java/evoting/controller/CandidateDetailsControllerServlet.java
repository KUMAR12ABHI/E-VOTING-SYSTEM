 ...
 * @author Soft2
 */
public class CandidateDetailsControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       RequestDispatcher rd=null;
        ...
        try
        {
            ...
            System.out.println("in candidate controller servlet:"+data);
            if(data.equals("cid"))
            {
                ArrayList<String> id=CandidateDao.getCandidateId();
                request.setAttribute("result", "cid");
